...
summary(mdl)
```
The speed is given in mph and the stopping distance is given in feet. The intercept is -17.57 feet and the stopping distance increases by 3.93 feet for each 1 mph increase in speed. The standard errors are 6.76 for the intercept and 0.415 for speed. The intercept is significant at the 0.05 level and the speed variable is significant at the 0.001 level.
...
3.12
#```{r, fig.align = "center", fig.height = 5, fig.width = 5,    out.width = "8.5in"}
```{r}
#BiocManager::install("DESeq2")
library("pheatmap")
