...
# For the full code to run the pipeline please see q2_6_alt_pipeline_script.sh
...
# Using an alternative algorithm is useful as it can surface previously unseen items that the main algorithm may have missed or help focus the search on the overlapping items.
